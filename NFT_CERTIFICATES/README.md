...
The frontend starter also provides an example of interactions with your CreateNftCertificateClient in [`AppCalls.tsx`](frontend/src/components/AppCalls.tsx) component by default.

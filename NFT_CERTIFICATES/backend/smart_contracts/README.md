...
By the default the template creates a single `HelloWorld` contract under create_nft_certificate folder in the `smart_contracts` directory. To add a new contract:
